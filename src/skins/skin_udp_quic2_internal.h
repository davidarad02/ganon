#ifndef GANON_SKINS_SKIN_UDP_QUIC2_INTERNAL_H
#define GANON_SKINS_SKIN_UDP_QUIC2_INTERNAL_H
...
typedef struct quic2_pending_data {
    uint64_t                   offset;
    size_t                     len;
    uint8_t                   *buf;
    struct quic2_pending_data *next;
} quic2_pending_data_t;
...
typedef struct {
    ...
    quic2_sign_cert_t                sign_cert;   /* embedded — not a pointer */
...
typedef struct {
    ...
    quic2_pending_data_t            *pending_data;
    quic2_pending_data_t            *pending_data_tail;
...
#endif /* GANON_SKINS_SKIN_UDP_QUIC2_INTERNAL_H */
